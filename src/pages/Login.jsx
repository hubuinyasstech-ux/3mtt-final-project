            ...
            {activeTab === "registerGuide" && (
              <div className="bg-[#292D4A]/80 border border-slate-700/70 rounded-2xl p-5 space-y-2.5 text-xs text-slate-200">
                <div className="flex items-center gap-2">
                  <span className="w-5 h-5 bg-[#008751] text-white rounded-full flex items-center justify-center font-bold text-[10px] flex-shrink-0">
                    1
                  </span>
                  <span>
          ...
          <div className="w-full max-w-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={
                  loading || (lockoutUntil && Date.now() < lockoutUntil)
                }
